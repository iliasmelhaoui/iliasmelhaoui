...
% ----- En-tête -----
\begin{center}
  \underline{\Large\textbf{Correction du contrôle séquence 1 version 1}}\\[0.3em]
...
% ----- En-tête -----
\begin{center}
  \underline{\Large\textbf{Correction du contrôle séquence 1 version 2}}\\[0.3em]
...
% =====================================================================
\vspace{1cm}\exercice
Le nombre de paquets doit diviser à la fois 98 et 126 : c'est un diviseur commun à
98 et 126. Pour en faire un maximum, on cherche le plus grand diviseur commun à 98 et 126.

Avec les décompositions en facteurs premiers :
$98 = 2 \times 7 \times 7$ et $126 = 2 \times 3 \times 3 \times 7$.
Le plus grand diviseur commun à 98 et 126 est le produit des facteurs premiers communs :
2 \times 7
                      = 14

Hulk et Batman peuvent donc faire au maximum \textbf{14 paquets},
chacun contenant  7 cookies et 9 tartelettes.
...
% ----- En-tête -----
\begin{center}
  \underline{\Large\textbf{Correction du contrôle séquence 1 version 3}}\\[0.3em]
...
% =====================================================================
\vspace{1cm}\exercice
Le nombre de paquets doit diviser à la fois 110 et 154 : c'est un diviseur commun à
110 et 154. Pour en faire un maximum, on cherche le plus grand diviseur commun à 110 et 154.

Avec les décompositions en facteurs premiers :
$110 = 2 \times 5 \times 11$ et $154 = 2 \times 7 \times 11$.
Le plus grand diviseur commun à 110 et 154 est le produit des facteurs premiers communs :
2 \times 11
                      = 22

Hulk et Batman peuvent donc faire au maximum \textbf{22 paquets},
chacun contenant  5 cookies et 7 tartelettes.
...
% ----- En-tête -----
\begin{center}
  \underline{\Large\textbf{Correction du contrôle séquence 1 version 4}}\\[0.3em]
...
% =====================================================================
\vspace{1cm}\exercice
Le nombre de paquets doit diviser à la fois 150 et 125 : c'est un diviseur commun à
150 et 125. Pour en faire un maximum, on cherche le plus grand diviseur commun à 150 et 125.

Avec les décompositions en facteurs premiers :
$150 = 2 \times 3 \times 5 \times 5$ et $125 = 5 \times 5 \times 5$.
Le plus grand diviseur commun à 150 et 125 est le produit des facteurs premiers communs :
5 \times 5
                      = 25

Hulk et Batman peuvent donc faire au maximum \textbf{25 paquets},
chacun contenant  6 cookies et 5 tartelettes.
...
% ----- En-tête -----
\begin{center}
  \underline{\Large\textbf{Correction du contrôle séquence 1 version 5}}\\[0.3em]
...
% =====================================================================
\vspace{1cm}\exercice
Le nombre de paquets doit diviser à la fois 84 et 147 : c'est un diviseur commun à
84 et 147. Pour en faire un maximum, on cherche le plus grand diviseur commun à 84 et 147.

Avec les décompositions en facteurs premiers :
$84 = 2 \times 2 \times 3 \times 7$ et $147 = 3 \times 7 \times 7$.
Le plus grand diviseur commun à 84 et 147 est le produit des facteurs premiers communs :
3 \times 7
                      = 21

Hulk et Batman peuvent donc faire au maximum \textbf{21 paquets},
chacun contenant  4 cookies et 7 tartelettes.
...
% ----- En-tête -----
\begin{center}
  \underline{\Large\textbf{Correction du contrôle séquence 1 version 6}}\\[0.3em]
...
% =====================================================================
\vspace{1cm}\exercice
Le nombre de paquets doit diviser à la fois 132 et 165 : c'est un diviseur commun à
132 et 165. Pour en faire un maximum, on cherche le plus grand diviseur commun à 132 et 165.

Avec les décompositions en facteurs premiers :
$132 = 2 \times 2 \times 3 \times 11$ et $165 = 3 \times 5 \times 11$.
Le plus grand diviseur commun à 132 et 165 est le produit des facteurs premiers communs :
3 \times 11
                      = 33

Hulk et Batman peuvent donc faire au maximum \textbf{33 paquets},
chacun contenant  4 cookies et 5 tartelettes.
...
% ----- En-tête -----
\begin{center}
  \underline{\Large\textbf{Correction du contrôle séquence 1 version 7}}\\[0.3em]
...
% =====================================================================
\vspace{1cm}\exercice
Le nombre de paquets doit diviser à la fois 140 et 175 : c'est un diviseur commun à
140 et 175. Pour en faire un maximum, on cherche le plus grand diviseur commun à 140 et 175.

Avec les décompositions en facteurs premiers :
$140 = 2 \times 2 \times 5 \times 7$ et $175 = 5 \times 5 \times 7$.
Le plus grand diviseur commun à 140 et 175 est le produit des facteurs premiers communs :
5 \times 7
                      = 35

Hulk et Batman peuvent donc faire au maximum \textbf{35 paquets},
chacun contenant  4 cookies et 5 tartelettes.
...
% ----- En-tête -----
\begin{center}
  \underline{\Large\textbf{Correction du contrôle séquence 1 version 8}}\\[0.3em]
...
% =====================================================================
\vspace{1cm}\exercice
Le nombre de paquets doit diviser à la fois 108 et 117 : c'est un diviseur commun à
108 et 117. Pour en faire un maximum, on cherche le plus grand diviseur commun à 108 et 117.

Avec les décompositions en facteurs premiers :
$108 = 2 \times 2 \times 3 \times 3 \times 3$ et $117 = 3 \times 3 \times 13$.
Le plus grand diviseur commun à 108 et 117 est le produit des facteurs premiers communs :
3 \times 3
                      = 9

Hulk et Batman peuvent donc faire au maximum \textbf{9 paquets},
chacun contenant  12 cookies et 13 tartelettes.
